...
// Individual resident codes (format: Initials-BldgShort-Phone4)
// Generated by generateResidentCode() in mockData.js
const RESIDENT_HINTS = [
    { code: 'AB-NW-4567', unit: '',        bldg: 'Norwest · Ahmed Benjelloun (Apt 1A)' },
    { code: 'NE-NW-7890', unit: '',        bldg: 'Norwest · Nadia El Fassi (Apt 1D)' },
    { code: 'RB-AT-0001', unit: '',        bldg: 'Atlas · Rachid Berrada (Apt A-02)' },
...
export default function LoginPage({ onResidentLogin }) {
    ...
    async function handleResidentSubmit(e) {
        ...
        // 1st try: individual resident code (format AB-NW-4567) — no unit needed
        ...
        if (!result) {
            setResidentError('Code invalide. Utilisez votre code personnel (ex : AB-NW-4567) ou le code de la résidence + votre numéro d\'appartement.')
                        ...
                        <form onSubmit={handleResidentSubmit} className="space-y-4">
                            <div>
                                ...
                                <input type="text" value={residentCode}
                                    ...
                                    placeholder="ex : AB-NW-4567 ou NRWST-2026"
                                    required
                                ...
                                <p className="text-[10px] text-slate-600 mt-1.5">Code personnel (ex&nbsp;: AB-NW-4567) ou code de la résidence</p>
                            </div>
                            <div>
                                <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">
